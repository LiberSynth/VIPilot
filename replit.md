...
Если хук мешает коммиту — это значит, что в коде есть нарушение конвенции. Нарушение нужно исправить, а не отключать хук. Пользователь явно запретил отключение хука.
