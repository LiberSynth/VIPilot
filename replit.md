...
- `cycle_config` — типизированные настройки производственного цикла (одна строка, id=1): text_prompt, format_prompt, video_post_prompt, video_duration, approve_stories, approve_movies, words_per_second
