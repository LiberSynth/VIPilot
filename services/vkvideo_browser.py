"""
Менеджер Playwright-браузера для авторизации на VK Видео.
...
VKVIDEO_PROFILE_DIR  = os.path.join(_PROJECT_ROOT, "data", "vkvideo_profile")

_browser = PlatformBrowser(
    platform_name="vkvideo",
    profile_dir=VKVIDEO_PROFILE_DIR,
