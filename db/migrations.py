...
# Миграции 1–96 удалены.


def _m097_fix_may_checkup_movie_id(cur):
    """Исправляет movie_id для батча «Майский чек-ап 2»."""
    cur.execute("""
        UPDATE batches
        SET movie_id = '798fefe4-029c-4b6c-be97-e253898d9f75'
        WHERE id = '9040e1f1-dbb8-4a81-8355-1188dcc2878a'
    """)
...
MIGRATIONS = [
    (97, _m097_fix_may_checkup_movie_id),
]
