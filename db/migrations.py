...
# Миграции 1–95 удалены.


def _m096_seed_may_batches(cur):
    """Добавляет два adhoc-батча «Майский пассаж 1» и «Майский чек-ап 2»."""
    cur.execute("""
        INSERT INTO batches (status, story_id, type, movie_id, title)
        VALUES
          ('published', '0a8cd5b5-eed9-43eb-bbc1-b85d9624c073', 'adhoc',
           '3c7fd64c-eadf-4a85-99d8-ae4d088724f1', 'Майский пассаж 1'),
          ('published', 'f6ae9ca1-dd60-453b-a67d-f78613bd73ed', 'adhoc',
           'f6ae9ca1-dd60-453b-a67d-f78613bd73ed', 'Майский чек-ап 2')
    """)
