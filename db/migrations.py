...
# Миграции 1–99 удалены.


def _m100(cur):
    """Привязать батч f3122829… к сюжету a8a0ca60… (ручная правка по запросу).

    Deployed: 2026-05-04
    """
    cur.execute(
        "UPDATE batches SET story_id = %s WHERE id = %s",
        ("a8a0ca60-d10c-4776-842d-979dd28d8daf",
         "f3122829-8487-4af2-86c7-635f6e489731"),
    )
