...
function openClearHistoryDialog() {
  ...
  new ConfirmDialog({
    ...
    text:
      'Будут удалены все батчи (включая активные), все логи и записи лога. Сюжеты, видеоролики (movies) и файлы в video/ не затрагиваются. Действие нельзя отменить.<br>' +
